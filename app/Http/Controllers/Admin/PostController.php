...
class PostController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        */
        ...
        try {
            $data['is_active'] = true;
            // com os 'posts' devem pertencem a um úsuario a linha abaixo força que os 'posts' pertençam.
            // $user = User::find(1);
            // utilizando a 'minddleware' de autenticação para obter as informações do uspuário autenticado.badge
            $user = auth()->user(); // para recuperar o usuario.
